			...
			foreach( $json_data['msg'] as $str => $val ) {
				...
				<tr style=" text-align: center;">
					...
					<td>
					    ...
					    <a href="dashboard.php?p=reviewPictures&uploaded_status=ok&id=<?php echo $val['id'];?>&action=approve&fb_id=<?php echo $val['fb_id'];?>&columName=<?php echo $val['columName'];?>"  style=" text-decoration: none; margin-right: 10px;">
						    <span class="Inpopup_button" style="background:green;">
                                Approve
                            </span>
						</a>
					    <a href="dashboard.php?p=reviewPictures&uploaded_status=ok&id=<?php echo $val['id'];?>&action=delete&fb_id=<?php echo $val['fb_id'];?>&columName=<?php echo $val['columName'];?>"  style=" text-decoration: none; margin-right: 10px;">
